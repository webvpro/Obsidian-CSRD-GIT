...
## Combat 
Making an attack in combat works the same way as any other roll: the GM assigns a [[Task-Difficulty|difficulty to the task]], and you roll a d20 against the associated target number.
...
### Heavy weapons
>Inflict 6 points of damage, and you must use two hands to attack with them. Heavy weapons are huge swords, great hammers, massive axes, halberds, heavy crossbows, blaster rifles, and so on. Anything that must be used in two hands is a heavy weapon.
## Special-Rolls
...
![[INDEX#Cypher System Rules Index| Table Of Contents]]
