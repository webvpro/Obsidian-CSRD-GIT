...
The full description for each listed ability can be found in the [Abilities](Abilities.md) chapter, which also contains descriptions for [Type](Type.md) and [Focus](Focus.md) abilities in a single vast catalog.  
## ![Descriptor](Descriptor.md#descriptor)  
## ![Focus](Focus.md#focus)   
## ![Abilities > Abilities](Abilities.md#abilities)  
## ![Equipment > Equipment](Equipment.md#equipment)  
  
  
# [INDEX > Cypher System Rules Index](INDEX.md#cypher-system-rules-index)